...
def fetch_from_osf(osf_resource_id: str, destination: str):
    """
    Recursively download all files from a PUBLIC OSF project or folder and extract archive files (zip/tar).

    Args:
        osf_resource_id (str): The OSF resource ID (e.g., 'dc745').
        destination (str): Local directory where files should be saved.
    """

    # No Authorization header needed — public access
    headers = {}
    ...
    def download_folder(folder_url, local_path):
        ...
        for entry in data["data"]:
            ...
            if kind == "folder":
                ...
                try_extract_archive(file_path, local_path)
...
if __name__ == "__main__":
    OSF_RESOURCE_ID = "dc745"   # replace with your OSF project/component ID
    DESTINATION = os.getcwd()   # saves into current dir
    fetch_from_osf(OSF_RESOURCE_ID, DESTINATION)